...
while [ "$valid" = false ]; do
    ...
    if [ -z "$choice" ]; then
        clear
        echo -e "[${RED}x${RESET}] ${RED}No input provided. Please enter 1 or 2.${RESET}\n"
        continue
    fi
    ...
    case $choice in
        ...
        *)
            clear
            echo -e "[${RED}x${RESET}] ${RED}Invalid choice ${INVERSE}$choice${RESET}${RED}. Please enter 1 or 2.${RESET}\n"
        ;;
    esac
done
